...
'''
date = 14
while firstDayOfVacation-date>0:
...
'''
 ...
 for x in range(27):
  if alphabet[x] == 'a' or alphabet[x] == 'e' or alphabet[x] == 'i' or alphabet[x] == 'o' or alphabet[x] == 'u' 
    print(alphabet[x]+" is a vowel")
  else:
    print(alphabet[x]+" is a consonant")
...
repro = 1
 for x in range(1, 61):
   for y in range(0,repro+1):
      babies = (random.randint(1,14))
      female += babies//2
      male += babies - (babies//2)
   if x == 12:
     repro += female
     female = 0
print(repro + female + male)
...
for i in range(0, len(num), 11):
    print(num[i:i + 11])
  #https://stackoverflow.com/questions/15917690/how-do-i-display-a-certain-amount-of-words-per-line
